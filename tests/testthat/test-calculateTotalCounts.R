...
##     # test:
##     load("/p/keles/DBChIP/volume4/Summaries/2016_06_18/Generated/Simulation1/DiffAnalysis_n3/Samples_123/Ns.RData")
##     expect_equal(fooDb@Ns, Ns)
## })
...
##     # test:
##     load("/p/keles/DBChIP/volume4/Summaries/2016_06_18/Generated/Simulation1/DiffAnalysis_n2/Samples_12/Ns.RData")
##     expect_equal(fooDb@Ns, Ns)
## })
...
test_that(" Simulation with n = 4", {
    ...
    expect_equal(tanDb_test@Ns, tanDb@Ns)
})
